    ...
    public static class Input {
        ...
        public void convertJosn(){
            ejson=Convert.securityJson(Convert.pairsToJson(
                    ...
                    new Pair<String, String>("head", head),new Pair<String, String>("account", account),
                    new Pair<String, String>("sex", sex+""),new Pair<String, String>("company", company),
                    new Pair<String, String>("note", note), new Pair<String, String>("audio", audio),
                    new Pair<String, String>("audioTime", audioTime),
                    new Pair<String, String>("position", position),new Pair<String, String>("isOpen", isOpen+""),
                    new Pair<String, String>("province", province),new Pair<String, String>("city", city)));//,new Pair<String, String>("area", area)
        }
