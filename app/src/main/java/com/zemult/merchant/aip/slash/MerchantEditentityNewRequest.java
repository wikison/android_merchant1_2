...
//实体商户入驻--添加全新的商户时
public class MerchantEditentityNewRequest extends PostStringRequest<Type>  {
    ...
    public MerchantEditentityNewRequest(Input input, ResponseListener listener) {
        super(Urls.BASIC_URL+Urls.MERCHANT_EDITENTITY_NEW,input.ejson , new TypeToken<CommonResult>() {
        }.getType() , listener);
