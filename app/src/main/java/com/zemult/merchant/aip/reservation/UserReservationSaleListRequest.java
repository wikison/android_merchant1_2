...
public class UserReservationSaleListRequest extends PostStringRequest<Type> {
    ...
    public UserReservationSaleListRequest(Input input, ResponseListener listener) {
        super(Urls.BASIC_URL + Urls.USER_RESERVATION_SALE_LIST, input.ejson, new TypeToken<APIM_UserReservationList>() {
        }.getType(), listener);
