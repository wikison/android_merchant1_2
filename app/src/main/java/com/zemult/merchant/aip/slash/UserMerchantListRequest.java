...
//获取用户的场景列表
public class UserMerchantListRequest extends PostStringRequest<Type>  {
    ...
    public UserMerchantListRequest(Input input, ResponseListener listener) {
        super(Urls.BASIC_URL+Urls.USER_MERCHANTLIST,input.ejson , new TypeToken<APIM_MerchantList>() {
        }.getType() , listener);
