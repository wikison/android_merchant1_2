...
public class CommonSysMessageListRequest extends PostStringRequest<Type> {
    ...
    public CommonSysMessageListRequest(Input input, ResponseListener listener) {
        super(Urls.BASIC_URL+Urls.COMMON_SYS_MESSAGELIST, input.ejson, new TypeToken<APIM_CommonSysMessageList>() {
        }.getType(), listener);
