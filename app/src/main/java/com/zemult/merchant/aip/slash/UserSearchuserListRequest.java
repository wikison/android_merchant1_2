...
//搜索用户列表
public class UserSearchuserListRequest extends PostStringRequest<Type>  {

    public UserSearchuserListRequest(Input input, ResponseListener listener) {
        super(Urls.BASIC_URL+Urls.USER_SEARCHUSERLIST, input.ejson, new TypeToken<APIM_SearchUsersList>() {
        }.getType(), listener);
