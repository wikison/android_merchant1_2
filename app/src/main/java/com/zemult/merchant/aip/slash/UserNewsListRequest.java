...
//获取 用户的方案列表(角色/场景/时间倒排序)
public class UserNewsListRequest extends PostStringRequest<Type> {
    ...
    public UserNewsListRequest(Input input, ResponseListener listener) {
        super(Urls.BASIC_URL+Urls.USER_NEWSLIST, input.ejson, new TypeToken<APIM_ManagerSearchnewsList>() {
        }.getType(), listener);
