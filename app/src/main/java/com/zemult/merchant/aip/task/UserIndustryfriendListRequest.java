...
//用户获取单角色好友列表
public class UserIndustryfriendListRequest extends PostStringRequest<Type>  {
    ...
    public UserIndustryfriendListRequest(Input input, ResponseListener listener) {
        super(Urls.BASIC_URL+Urls.USER_INDUSTRYFRIENDLIST,input.ejson , new TypeToken<APIM_UserFriendList>() {
        }.getType() , listener);
