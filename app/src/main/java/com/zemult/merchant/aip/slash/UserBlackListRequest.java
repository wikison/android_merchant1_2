...
//   用户的黑名单列表
public class UserBlackListRequest extends PostStringRequest<Type>  {
    ...
    public UserBlackListRequest(Input input, ResponseListener listener) {
        super(Urls.BASIC_URL+Urls.USER_BLACK_LIST,input.ejson , new TypeToken<APIM_SearchUsersList>() {
        }.getType() , listener);
