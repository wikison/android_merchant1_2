...
public class UserMessageListBill_1_2_2Request extends PostStringRequest<Type> {
    ...
    public UserMessageListBill_1_2_2Request(Input input, ResponseListener listener) {
        super(Urls.BASIC_URL+Urls.USER_MESSAGELIST_BILL_1_2_2, input.ejson, new TypeToken<APIM_CommonSysMessageList>() {
        }.getType(), listener);
