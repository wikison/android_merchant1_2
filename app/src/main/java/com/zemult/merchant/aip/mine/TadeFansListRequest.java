 ...
 */
//TA的粉丝
public class TadeFansListRequest extends PostStringRequest<Type> {
    ...
    public TadeFansListRequest(Input input, ResponseListener listener) {
        super(Urls.BASIC_URL+Urls.USER_FANSLIST_OTHER_1_2, input.ejson, new TypeToken<APIM_UserFansList>() {
        }.getType(), listener);
