 ...
 */
public class HomeChildNew4KeyWordsAdapter extends BaseListAdapter<M_Merchant> {

    private boolean isNoData;
    private int mHeight;

    public HomeChildNew4KeyWordsAdapter(Context context, List<M_Merchant> list) {
        super(context, list);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null && convertView instanceof LinearLayout) {
            ...
            convertView = mInflater.inflate(R.layout.item_home_child_new4keywords, null);
