 ...
 */
public class PartyHomeListAdapter extends BaseListAdapter<M_Task> {

    private int pagePosition = 0;

    private OnTaskDetailClickListener onTaskDetailClickListener;

    public PartyHomeListAdapter(Context context, List<M_Task> mTaskList) {
        super(context, mTaskList);
    }

    public PartyHomeListAdapter(Context context, List<M_Task> mTaskList, int pagePosition) {
        super(context, mTaskList);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_partyhomelist, null, false);
    ...
    private void initData(ViewHolder holder, M_Task entity) {
        ...
        holder.tvRoleName.setText(String.format("%sde任务", entity.industryName));
