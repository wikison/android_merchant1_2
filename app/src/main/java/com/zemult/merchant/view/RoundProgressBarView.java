...
public class RoundProgressBarView extends View {
    ...
    public RoundProgressBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray mTypedArray2 = context.obtainStyledAttributes(attrs,
                R.styleable.gridPasswordView);

        //获取自定义属性和默认值
        roundColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundColor, Color.WHITE);
        roundProgressColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundProgressColor, getResources().getColor(R.color.bg_head));
        textColor = mTypedArray2.getColor(R.styleable.gridPasswordView_textColor, Color.GREEN);
        textSize = mTypedArray2.getDimension(R.styleable.gridPasswordView_textSize, 15);
