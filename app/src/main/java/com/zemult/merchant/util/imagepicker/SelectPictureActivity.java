...
//                .imageScaleType(ImageScaleType.EXACTLY).bitmapConfig(Bitmap.Config.RGB_565).build();
    ...
    class PictureAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position == 0) {
                holder.iv.setImageResource(R.mipmap.paizhao_02);
...
//                loader.displayImage("file://" + item.path, holder.iv, options);
                imageManager.loadLocalImage(item.path, holder.iv);
...
//            loader.displayImage("file://" + item.getFirstImagePath(), holder.id_dir_item_image, options);
            imageManager.loadLocalImage(item.getFirstImagePath(), holder.id_dir_item_image);
