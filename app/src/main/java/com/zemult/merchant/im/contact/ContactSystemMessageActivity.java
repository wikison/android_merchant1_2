...
public class ContactSystemMessageActivity extends MBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IWxCallback callback = new IWxCallback() {
            ...
            public void onSuccess(Object... result) {
                contactsFromCache = contactService.getContactsFromCache();
                init();
            }
    ...
    private void init(){
        ...
        for(int k=0;k<contactsFromCache.size();k++){
            for(int i=0;0<mList.size();i++){
                if(mList.get(i).getAuthorUserId().equals(contactsFromCache.get(k).getUserId())){
                    mList.remove(i);
                }
            }
        }
    ...
    private void initTitle() {
        ...
        titleBar.setBackgroundColor(Color.parseColor("#FFA726"));//00b4ff
