...
import com.zemult.merchant.im.sample.TribeMsgRecTypeSetActivity;
...
public class TribeInfoActivity extends Activity {
    ...
    private void updateView() {
        ...
        if (master != null) {
            mTribeMaster.setText(SlashHelper.userManager().getUserinfo().getName());//master.getUserId()   master.getShowName()
        }
