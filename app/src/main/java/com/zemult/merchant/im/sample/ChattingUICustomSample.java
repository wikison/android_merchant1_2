...
import com.zemult.merchant.im.tribe.TribeInfoActivity;
...
//        view.setBackgroundColor(Color.WHITE);//Color.parseColor("#FFA726")
...
//        backView.setTextColor(Color.parseColor("#FFA726"));
        backView.setTextSize(15);
        backView.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.back_btn, 0, 0, 0);
        ...
        if (conversation.getConversationType() == YWConversationType.Tribe) {
            btn.setImageResource(R.mipmap.gengduo_black_icon);
