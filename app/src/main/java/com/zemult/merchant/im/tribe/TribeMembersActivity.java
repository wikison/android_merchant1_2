    ...
    private void init() {
        ...
        mAddTribeMembers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ArrayList mContactUserIds=new ArrayList();
                for(String idstr:mContactUserIdSet){
                    mContactUserIds.add(idstr);
                }
                ...
                intent.putStringArrayListExtra("userIdlist", mContactUserIds);
