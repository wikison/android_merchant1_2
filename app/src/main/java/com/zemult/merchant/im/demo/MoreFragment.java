...
import com.zemult.merchant.im.common.SimpleWebViewActivity;
import com.zemult.merchant.im.sample.DemoSimpleKVStore;
import com.zemult.merchant.im.sample.LoginSampleHelper;
import com.zemult.merchant.im.sample.NotificationInitSampleHelper;
import com.zemult.merchant.im.test.MultiAccountTestActivity;
    ...
    public void logout() {
        ...
        mLoginService.logout(new IWxCallback() {
            ...
            public void onSuccess(Object... arg0) {
                Toast.makeText(AppApplication.getContext(), "退出成功", Toast.LENGTH_SHORT).show();
                YWLog.i(TAG, "退出成功");
